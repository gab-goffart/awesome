...
theme.widget_fg = xrdb.color4
theme.widget_bg = xrdb.color13
...
theme.notification_fg = xrdb.color15
...
--theme.separator_text = "  "
--theme.separator_text = "  "
theme.separator_fg = xrdb.color15
...
theme.wibar_fg = xrdb.color15
theme.wibar_bg = xrdb.color8
...
theme.wibar_alt_fg = xrdb.color15
